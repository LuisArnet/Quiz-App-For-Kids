...
@interface QuizThirteenViewController : UIViewController
...
@property (weak, nonatomic) IBOutlet UILabel *lblProblemtop;
@property (weak, nonatomic) IBOutlet UILabel *lblProblemunder;
