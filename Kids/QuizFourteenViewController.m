...
#import "QuizFourteenViewController.h"

@interface QuizFourteenViewController (){
...
@implementation QuizFourteenViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    order=0;
    topproblemArray=[[NSArray alloc] initWithObjects:@"234*",@"123*",@"321*",@"456*",@"654",nil];
    underproblemArray=[[NSArray alloc] initWithObjects:@"34",@"45",@"98",@"23",@"*43", nil];
    firstArray=[[NSArray alloc] initWithObjects:@"7956",@"5532",@"12054",@"19608",@"28122", nil];
    secondArray=[[NSArray alloc] initWithObjects:@"7957",@"5533",@"12053",@"19607",@"28123", nil];
    thirdArray=[[NSArray alloc] initWithObjects:@"7958",@"5534",@"12052",@"19609",@"28124", nil];
    fourArray=[[NSArray alloc] initWithObjects:@"7959",@"5535",@"12056",@"19610",@"28125", nil];
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex {
    ...
    if (alertView.tag==2) {
        if (buttonIndex == 0) {
            // do something here...
            QuizFifteenViewController *quizViewCtrl=[[QuizFifteenViewController alloc] init];
